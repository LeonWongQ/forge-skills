...
## Root Cause Quality
- [ ] Trigger identified (what initiated the failure)
- [ ] Mechanism identified (how trigger propagated to symptom)
- [ ] Enabling condition identified (why the system allowed this)
