...
3. Detect technical domains from the subject:
   - Java code/docs → `.Codex/forge/domains/java.md`
   - Spring code/docs → `.Codex/forge/domains/spring.md`
   - Database docs → `.Codex/forge/domains/mysql.md`
   - Cache/Redis docs → `.Codex/forge/domains/redis.md`
   - Test docs → `.Codex/forge/domains/testing.md`
...
| Module | Path | Role |
|--------|------|------|
| Behavior | `.Codex/forge/behaviors/document.md` | Primary: accuracy, clarity, audience fit |
| Domains | Detected from subject | Domain-specific terminology, conventions, context |
| Template | `.Codex/forge/templates/default.md` | Flexible output shape (documentation is format-diverse) |
