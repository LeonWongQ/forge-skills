...
4. Detect technical domains from the error source:
   - JDBC / SQLException → `.Codex/forge/domains/mysql.md`
   - Spring / Bean / Transaction → `.Codex/forge/domains/spring.md`
   - Redis / Jedis / Lettuce → `.Codex/forge/domains/redis.md`
   - JVM / GC / OOM → `.Codex/forge/domains/java.md`
   - Test failures, assertion errors → `.Codex/forge/domains/testing.md`
...
| Module | Path | Role |
|--------|------|------|
| Behavior | `.Codex/forge/behaviors/debug.md` | Debug discipline applied to error artifacts |
| Domains | Detected from error source | Domain-specific failure patterns |
| Template | `.Codex/forge/templates/debug-report.md` | Adapted for error artifact analysis |
| Checklists | `.Codex/forge/checklists/general-quality.md`, `.Codex/forge/checklists/debug-checklist.md`, `.Codex/forge/checklists/delivery-checklist.md` | |
...
### Pattern Matching
Match the error against known failure patterns for the detected domain. See `.Codex/skills/error-analysis/references/error-patterns.md` for domain-specific patterns.
