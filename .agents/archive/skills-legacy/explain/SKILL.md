...
3. Detect technical domains from the topic:
   - Spring concepts → `.Codex/forge/domains/spring.md`
   - Java language/runtime → `.Codex/forge/domains/java.md`
   - Database topics → `.Codex/forge/domains/mysql.md`
   - Cache topics → `.Codex/forge/domains/redis.md`
   - Testing topics → `.Codex/forge/domains/testing.md`
...
| Module | Path | Role |
|--------|------|------|
| Behavior | `.Codex/forge/behaviors/explain.md` | Primary: concept clarification, mental model building |
| Domains | Detected from topic | Domain-specific context and examples |
| Template | `.Codex/forge/templates/explanation.md` | Output: what → why → how → example → pitfalls |
| Checklists | `.Codex/forge/checklists/general-quality.md`, `.Codex/forge/checklists/delivery-checklist.md` | |
