...
|-------------|----------|----------|
| New feature, implementation, rollout, migration | `.Codex/forge/templates/implementation-plan.md` | General (task-level) |
| Structural improvement, redesign, cleanup, modernization | `.Codex/forge/templates/refactor-plan.md` | `.Codex/forge/behaviors/refactor.md` |
| Unclear | Ask: "Is this a new implementation or a refactoring of existing code?" |

See `.Codex/skills/plan/references/type-selection.md` for detailed decision guide.
...
| Module | Path |
|--------|------|
| Template | `.Codex/forge/templates/implementation-plan.md` |
...
| Module | Path |
|--------|------|
| Behavior | `.Codex/forge/behaviors/refactor.md` |
| Template | `.Codex/forge/templates/refactor-plan.md` |
| Checklists | `.Codex/forge/checklists/general-quality.md`, `.Codex/forge/checklists/refactor-checklist.md`, `.Codex/forge/checklists/verification-checklist.md`, `.Codex/forge/checklists/delivery-checklist.md` |
| Workflow | `workflow.full_default` |
