...
3. Detect technical domains from report subject:
   - Test results → `.Codex/forge/domains/testing.md`
   - Java/Spring service incident → `.Codex/forge/domains/java.md`, `.Codex/forge/domains/spring.md`
   - Database incident → `.Codex/forge/domains/mysql.md`
   - Cache incident → `.Codex/forge/domains/redis.md`
...
|-------------|------------|----------------|----------------------|
| Test execution results, test summary | Test Report | `.Codex/forge/templates/test-report.md` | `.Codex/forge/reports/task-report.md` |
| Production incident, outage, postmortem | Incident Report | — | `.Codex/forge/reports/incident-report.md` |
| Code/design review summary, PR wrap-up | Review Summary | — | `.Codex/forge/reports/review-summary.md` |
| General task completion, analysis findings | Task Report | — | `.Codex/forge/reports/task-report.md` |
| Ambiguous | Ask: "What type of report: test results, incident/postmortem, review summary, or general task report?" | | |

See `.Codex/skills/report/references/format-selector.md` for detailed selection guide.
...
| Module | Path |
|--------|------|
| Template | `.Codex/forge/templates/test-report.md` |
| Checklists | `.Codex/forge/checklists/general-quality.md`, `.Codex/forge/checklists/test-report-checklist.md`, `.Codex/forge/checklists/delivery-checklist.md` |
| Report | `.Codex/forge/reports/task-report.md` |

### Incident Report
| Module | Path |
|--------|------|
| Behavior | `.Codex/forge/behaviors/debug.md` (for root cause analysis) |
| Checklists | `.Codex/forge/checklists/general-quality.md`, `.Codex/forge/checklists/verification-checklist.md`, `.Codex/forge/checklists/delivery-checklist.md` |
| Report | `.Codex/forge/reports/incident-report.md` |

### Review Summary
| Module | Path |
|--------|------|
| Behavior | `.Codex/forge/behaviors/review.md` |
| Checklists | `.Codex/forge/checklists/general-quality.md`, `.Codex/forge/checklists/review-checklist.md`, `.Codex/forge/checklists/delivery-checklist.md` |
| Report | `.Codex/forge/reports/review-summary.md` |
