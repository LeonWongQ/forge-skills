...
| Domains | `.Codex/forge/domains/testing.md` | Core: test strategy, assertions, isolation, coverage |
| | Detected from target under test | Technology-specific failure modes and test patterns |
| Template | `.Codex/forge/templates/test-plan.md` | Output: 15-section structured test plan |
