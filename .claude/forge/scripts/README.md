...
```powershell
python .claude/forge/scripts/sync-codex-skills.py --check
python .claude/forge/scripts/sync-codex-skills.py
python .claude/forge/scripts/sync-codex-skills.py --watch
```
...
```powershell
python .claude/forge/scripts/sync-agent-skills.py --client codex --scope global --check
python .claude/forge/scripts/sync-agent-skills.py --client claude --scope global --check
python .claude/forge/scripts/sync-agent-skills.py --client cursor --scope global --check
```
...
```powershell
python .claude/forge/scripts/run-skill-evals.py --prepare .skill-eval/prepared
```

When the user chooses automated execution, check only that selected backend:

```powershell
python .claude/forge/scripts/run-skill-evals.py --list-backends
python .claude/forge/scripts/run-skill-evals.py --list-backends --json
python .claude/forge/scripts/run-skill-evals.py --preflight --backend codex
python .claude/forge/scripts/run-skill-evals.py --preflight --backend claude
```
...
```powershell
python .claude/forge/scripts/run-skill-evals.py --output .skill-eval/candidate --backend claude --confirm-llm-evaluation --confirm-claude-unisolated-filesystem --label candidate-v1 --model <model-id>
```
...
```powershell
python .claude/forge/scripts/prepare-skill-eval-review.py --run <run-1>/run.json --run <run-2>/run.json --output .skill-eval/manual-review
```
...
```powershell
python .claude/forge/scripts/score-skill-evals.py --run .skill-eval/candidate/run.json --decisions .skill-eval/candidate/decisions.json --output .skill-eval/candidate/scored.json
```
...
```powershell
python .claude/forge/scripts/freeze-skill-eval-baseline.py --package .skill-eval/manual-review --output .skill-eval/baselines/baseline-v1 --label baseline-v1
```
...
```powershell
python .claude/forge/scripts/compare-skill-evals.py --baseline .skill-eval/baselines/baseline-v1 --candidate .skill-eval/candidate/scored.json --output .skill-eval/comparisons/candidate-v1
```
...
```powershell
python .claude/forge/scripts/run-skill-evals.py --output .skill-eval/timeout-retry --backend codex --confirm-llm-evaluation --case <case-id> --timeout-multiplier 2
```
