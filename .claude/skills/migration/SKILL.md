...
4. Detect other technical domains from the migration context:
   ...
   - Testing → `.claude/forge/domains/testing.md`
...
| Template | `.claude/forge/templates/implementation-plan.md` | Output: objective → assumptions → approach → steps → risks → validation |
