...
|-------------|----------|----------|
| New feature, implementation, rollout, migration | `.claude/forge/templates/implementation-plan.md` | General (task-level) |
| Structural improvement, redesign, cleanup, modernization | `.claude/forge/templates/refactor-plan.md` | `.claude/forge/behaviors/refactor.md` |
| Unclear | Ask: "Is this a new implementation or a refactoring of existing code?" |

See `.claude/skills/plan/references/type-selection.md` for detailed decision guide.
...
| Module | Path |
|--------|------|
| Template | `.claude/forge/templates/implementation-plan.md` |
...
| Module | Path |
|--------|------|
| Behavior | `.claude/forge/behaviors/refactor.md` |
| Template | `.claude/forge/templates/refactor-plan.md` |
| Checklists | `.claude/forge/checklists/general-quality.md`, `.claude/forge/checklists/refactor-checklist.md`, `.claude/forge/checklists/verification-checklist.md`, `.claude/forge/checklists/delivery-checklist.md` |
| Workflow | `workflow.full_default` |
