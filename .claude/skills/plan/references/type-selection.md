...
| Template | `.claude/forge/templates/implementation-plan.md` | `.claude/forge/templates/refactor-plan.md` |
| Primary behavior | none (task-level) | `.claude/forge/behaviors/refactor.md` |
