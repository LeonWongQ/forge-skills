...
Compose only the required Forge modules: `.claude/forge/domains/testing.md`, `workflow.full_default`, the implementation-plan template, and general quality, verification, and delivery checklists.
