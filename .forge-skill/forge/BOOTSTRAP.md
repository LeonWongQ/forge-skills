...
When other projects symlink to this repo's `.forge-skill/forge/` and `.claude/skills/`, their `CLAUDE.md` has no entry point into the forge discovery chain. This file provides:
...
```markdown
<!-- FORGE-BOOTSTRAP — symlinked forge entry point. Docs: .forge-skill/forge/BOOTSTRAP.md -->
...
### Discovery sequence
1. `.forge-skill/forge/CLAUDE.md` — universal principles, invariants, decision hierarchy
2. `.forge-skill/forge/AUTOLOAD.md` — selective activation and host ownership gate
...
5. Pack match: `.forge-skill/forge/packs/` — technology-specific fast paths
5. Manual routing: `.forge-skill/forge/runtime/router.md` — behavior + domains + workflow + template + checklists
