...
4. Detect technical domains from the error source:
   - JDBC / SQLException → `.forge-skill/forge/domains/mysql.md`
   - Spring / Bean / Transaction → `.forge-skill/forge/domains/spring.md`
   - Redis / Jedis / Lettuce → `.forge-skill/forge/domains/redis.md`
   - JVM / GC / OOM → `.forge-skill/forge/domains/java.md`
   - Test failures, assertion errors → `.forge-skill/forge/domains/testing.md`
...
| Module | Path | Role |
|--------|------|------|
| Behavior | `.forge-skill/forge/behaviors/debug.md` | Debug discipline applied to error artifacts |
| Domains | Detected from error source | Domain-specific failure patterns |
| Template | `.forge-skill/forge/templates/debug-report.md` | Adapted for error artifact analysis |
| Checklists | `.forge-skill/forge/checklists/general-quality.md`, `.forge-skill/forge/checklists/debug-checklist.md`, `.forge-skill/forge/checklists/delivery-checklist.md` | |
...
### Pattern Matching
Match the error against known failure patterns for the detected domain. See `.forge-skill/skills/error-analysis/references/error-patterns.md` for domain-specific patterns.
