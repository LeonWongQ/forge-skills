...
Use `python -m forge_cli` from `.forge-skill/forge` while developing the source. `python .claude/skills/forge/forge.py` remains a backward-compatible shim that delegates to the package CLI.
