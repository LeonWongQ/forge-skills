...
4. Detect technical domains from the target codebase:
   ...
   - Playwright/UI → `.forge-skill/forge/domains/playwright.md`
   - Always load `.forge-skill/forge/domains/testing.md` when writing alongside tests
...
| Template | `.forge-skill/forge/templates/default.md` | Adapted for delivery: result → changed behavior/files → verification → remaining risk |
