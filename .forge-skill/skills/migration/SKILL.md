...
4. Detect other technical domains from the migration context:
   ...
   - Spring AI → `.forge-skill/forge/domains/spring-ai.md`
...
| Template | `.forge-skill/forge/templates/implementation-plan.md` | Output: objective → assumptions → approach → steps → risks → validation |
