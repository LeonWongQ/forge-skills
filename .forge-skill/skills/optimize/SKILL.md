...
4. Detect technical domains from the target:
   - Java code → `.forge-skill/forge/domains/java.md`
   - Spring / database → `.forge-skill/forge/domains/spring.md`, `.forge-skill/forge/domains/mysql.md`
   - Cache → `.forge-skill/forge/domains/redis.md`
...
| Module | Path | Role |
|--------|------|------|
| Behavior | `.forge-skill/forge/behaviors/optimize.md` | Primary: performance, efficiency, scalability improvement |
| Domains | Detected from target | Technology-specific optimization heuristics |
| Template | `.forge-skill/forge/templates/implementation-plan.md` | Output: objective → approach → steps → risks → validation |
| Checklists | `.forge-skill/forge/checklists/general-quality.md` | Baseline quality |
| | `.forge-skill/forge/checklists/verification-checklist.md` | Performance claims must be justified |
