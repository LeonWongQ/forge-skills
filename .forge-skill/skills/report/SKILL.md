...
3. Detect technical domains from report subject:
   - Test results → `.forge-skill/forge/domains/testing.md`
   - Java/Spring service incident → `.forge-skill/forge/domains/java.md`, `.forge-skill/forge/domains/spring.md`
   - Database incident → `.forge-skill/forge/domains/mysql.md`
   - Cache incident → `.forge-skill/forge/domains/redis.md`
...
|-------------|------------|----------------|----------------------|
| Test execution results, test summary | Test Report | `.forge-skill/forge/templates/test-report.md` | `.forge-skill/forge/reports/task-report.md` |
| Production incident, outage, postmortem | Incident Report | — | `.forge-skill/forge/reports/incident-report.md` |
| Code/design review summary, PR wrap-up | Review Summary | — | `.forge-skill/forge/reports/review-summary.md` |
| General task completion, analysis findings | Task Report | — | `.forge-skill/forge/reports/task-report.md` |
| Ambiguous | Ask: "What type of report: test results, incident/postmortem, review summary, or general task report?" | | |

See `.forge-skill/skills/report/references/format-selector.md` for detailed selection guide.
...
| Module | Path |
|--------|------|
| Template | `.forge-skill/forge/templates/test-report.md` |
| Checklists | `.forge-skill/forge/checklists/general-quality.md`, `.forge-skill/forge/checklists/test-report-checklist.md`, `.forge-skill/forge/checklists/delivery-checklist.md` |
| Report | `.forge-skill/forge/reports/task-report.md` |

### Incident Report
| Module | Path |
|--------|------|
| Behavior | `.forge-skill/forge/behaviors/debug.md` (for root cause analysis) |
...
| Report | `.forge-skill/forge/reports/incident-report.md` |

### Review Summary
| Module | Path |
|--------|------|
| Behavior | `.forge-skill/forge/behaviors/review.md` |
| Checklists | `.forge-skill/forge/checklists/general-quality.md`, `.forge-skill/forge/checklists/review-checklist.md`, `.forge-skill/forge/checklists/delivery-checklist.md` |
| Report | `.forge-skill/forge/reports/review-summary.md` |
