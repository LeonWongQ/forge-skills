...
3. Detect technical domains from the target under test:
   ...
   - Playwright → `.forge-skill/forge/domains/playwright.md`
   - Always load `.forge-skill/forge/domains/testing.md`
...
| Domains | `.forge-skill/forge/domains/testing.md` | Core: test strategy, assertions, isolation, coverage |
| | Detected from target under test | Technology-specific failure modes and test patterns |
| Template | `.forge-skill/forge/templates/test-plan.md` | Output: 15-section structured test plan |
| Checklists | `.forge-skill/forge/checklists/general-quality.md` | Baseline quality |
| | `.forge-skill/forge/checklists/test-plan-checklist.md` | Test plan completeness |
