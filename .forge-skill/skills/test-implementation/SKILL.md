...
| Domains | `.forge-skill/forge/domains/testing.md` | Core: assertions, isolation, determinism, coverage |
| | Detected from code under test | Technology-specific testing patterns |
| Template | `.forge-skill/forge/templates/test-plan.md` | Output structure for test plan (scope → strategy → cases → verification) |
